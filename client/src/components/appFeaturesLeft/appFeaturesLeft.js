                ...
                <div className='bundleFeature'>
                    ...
                    <div className='buldleBox'>
                                                            ...
                                                            <div className='mainTab' onClick={(e)=>this.setSelected(value.id)}>
                                                                <div className='bundleDetail'>
                                                                    <div className='bundleImg'>
                                                                        ...
                                                                        {value.selected_feature_count}/{value.total_features}
                                                                        </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div className='rightsidePanel'>
                            {this.state.features.map(value=>
                                value.id==this.state.selected?<React.Fragment>
                                    <div className='featureHead'>
                            <h3>Features({value.selected_feature_count}/{value.total_features})</h3>
                            <div className="checkBox">
                                <input type="checkbox" id={value.id}></input>
                                <label htmlFor={value.id} onClick={(e)=>this.selectAll(e)}>{this.state.selectAll?'':'Select All'}</label>
                                <label htmlFor={value.id} onClick={(e)=>this.deselectAll(e)}>{this.state.selectAll?'Deselect All':''}</label>
                            </div>
                            </div>
                            <div className='featureText'>
                                <h3>{value.title}</h3>
                                <div class="checkBox"><input type="checkbox" id={value.id}></input><label for={`m+${value.checkId}`}>Select All</label></div>
                                                    ...
                                                    <li className='active'>
                                                        <div className='featureTab' onClick={(e)=>this.selectFeature(li.id)}>
                                                            <div className='featureDetail'>
                                                                ...
                                                                <div className="featureName"><h3>{li.title}</h3><p>{li.feature_weeks}</p><h4>{li.feature_price}</h4></div>
                                                            </div>
